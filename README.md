...
- **Browse deck builders** and community lists.
- **Report bugs** quickly from Discord.
- **Try fun commands** like `/8ball`.
...
> Tip: Autocomplete is your best friend. Start typing a deck, card, or hero name and select from the list.

## Deck Browsing Tips

- **Use hero commands** for the cleanest results (for example `/gsdecks`, `/sfdecks`, `/rbdecks`).
- **Pick from autocomplete** to avoid typos.
- **Use navigation buttons** to move between deck pages.

## Card Lookup Tips

- **Use `/cardinfo`** for detailed stats, abilities, and descriptions.
- **Use `/cardsearch`** to find decks that include a card you like.
