...
async function sendDeckbuilderDeleteLog(client, row, deletedBy) {
  ...
  const embed = new EmbedBuilder()
    ...
    .addFields(
      {
        name: "Deckbuilder",
        value: row.deckbuilder_name || "N/A",
        inline: true,
      },
      {
        name: "Discord User",
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      try {
        await sendDeckbuilderDeleteLog(
          interaction.client,
          deckbuilder,
          interaction.user,
        );
        ...
        logMessage =
          " The deckbuilder was deleted, but I could not send the log message.";
      }
